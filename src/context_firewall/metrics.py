...
PROXY_DURATION = Histogram(
    "contextwall_proxy_request_duration_seconds",
...
PIPELINE_SLICES = Histogram(
    "contextwall_pipeline_slices_returned",
...
PIPELINE_TOKENS = Histogram(
    "contextwall_pipeline_tokens_returned",
...
POLICY_ENFORCEMENTS = Counter(
    "contextwall_policy_enforcements_total",
...
ERRORS = Counter(
    "contextwall_errors_total",
    "Internal errors by component",
    ["component"],  # proxy | pipeline | policy
)

# ── Key management ─────────────────────────────────────────────────────────────

PROXY_KEYS_ACTIVE = Gauge(
    "contextwall_proxy_keys_active",
